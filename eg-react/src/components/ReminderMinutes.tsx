...
const ReminderMinutes: React.FC<AppProps> = ({ user }) => {
    ...
    useEffect(() => {
        if (iat !== null && exp !== null) {
            ...
            if (timeUntilExpiry <= 0) {
                ...
                if (timerId) clearInterval(timerId);
            } else if (timeUntilExpiry <= 180) { // Less than 3 minutes remaining
    ...
    const divStyle: React.CSSProperties = {
        ...
        backgroundImage: 'url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRzANZRIuvAcSaKQOPr4wmLi6dUgSTJslMRfEHJh7j4wA&s)',
...
export default ReminderMinutes;